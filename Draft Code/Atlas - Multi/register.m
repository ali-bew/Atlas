function [outputArg1] = register(inputArg1,method,Threshold)
...
if nargin > 0
    ...
    logg(strcat('Chosen files :',mat2str(arrI)));
end
    ...
    for i = starting:N %i is the fixed image 
        ...
        for j = 1:40
            ...
            if i ~= j
                ...
                fixedMaskPath = strcat(currentFolder , '\Data\Validation_Set\IBSR_',ppi,num2str(i),'\IBSR_',ppi,num2str(i),'_mask.nii');
