...
%                     
            for j = 0:N    
                ...
                outputFolder = strcat(strcat(currentFolder ,'\Data\Training_Set'),'m150\IBSR_',ppj,num2str(j)); 
...
%                 end
                ...
                if true && isfile(movingImagePath) %i~=j
                    ...
                    mkdir(outputFolder);
                    niftiwriteB(movingImage1,movingImagePath,strcat(outputFolder,'\IBSR_',ppj,num2str(j),'.nii'));
