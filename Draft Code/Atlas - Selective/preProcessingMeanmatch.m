function [outputArg1] = preProcessingMeanmatch(inputArg1)
close all;clear all;
...
currentFolder = 'C:\Users\developer\Desktop\bew\Courses Girona\Project ISA - MIRA';
    ...
    turr = 1;
    for i = 13:13 %choice of  reference 
        if i < 10
        ...
        tur = 1;
        fixedImagePath = strcat(currentFolder , '\Data\Validation_Set Orig\IBSR_',ppi,num2str(i),'\IBSR_',ppi,num2str(i),'.nii');
...
%                     
            for j = 0:N    
                ...
                outputFolder = strcat(strcat(currentFolder ,'\Data\Training_Set'),num2str(i),'m150\IBSR_',ppj,num2str(j)); 
